...
# Resource allocation.
#SBATCH --job-name=ViT_age_multi   # Job name
...
#SBATCH --output=ViT_age_multi_%j.log   # Standard output and error log
...
TRAINING_SCRIPT="$(realpath "/red/ruogu.fang/leem.s/NSF-SCH/code/train_regression_multi.py")"
TRAINING_CMD="$TRAINING_SCRIPT --random_state 0 --image_dir /red/ruogu.fang/UKB/data/Eye/21015_fundus_left_1/ --csv_dir /red/ruogu.fang/leem.s/NSF-SCH/data/sex.csv --eye_code _21015_0_0.png --label_code 21003-0.0 --working_dir ViT_age --model_name ViT_age --lr 2e-4 --epoch 100"
