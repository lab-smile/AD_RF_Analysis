...
#################################################
#################################################
#SBATCH --job-name=Swin_classi   # Job name
#SBATCH --nodes=4
#SBATCH --ntasks=4
#SBATCH --gpus=32            ###
...
TRAINING_SCRIPT="$(realpath "./train_classification_multi_mlflow-3.py")"
TRAINING_CMD="$TRAINING_SCRIPT --random_state 0 --left_image_dir /red/ruogu.fang/share/UKB/data/Eye/21015_fundus_left_1_good/ --right_image_dir /red/ruogu.fang/share/UKB/data/Eye/21016_fundus_right_1_horizontal_good/ --csv_dir /red/ruogu.fang/leem.s/NSF-SCH/data/classification_data2.csv --left_eye_code _21015_0_0.png --right_eye_code _21016_0_0.png --label sex smoking sleeplessness alcohol depression economic_status --exclude -1 -2 -3 --working_dir Swin_classification --model_name Swin_classification --epoch 100 --input_size 576 --base_model microsoft/swin-large-patch4-window12-384-in22k --lr 1e-4"
